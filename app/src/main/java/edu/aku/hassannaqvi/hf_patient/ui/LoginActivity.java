...
import static edu.aku.hassannaqvi.hf_patient.core.MainApp.editor;
import static edu.aku.hassannaqvi.hf_patient.core.MainApp.sharedPref;
import static edu.aku.hassannaqvi.hf_patient.database.CreateTable.DATABASE_COPY;
import static edu.aku.hassannaqvi.hf_patient.database.CreateTable.DATABASE_NAME;
...
import edu.aku.hassannaqvi.hf_patient.core.AppInfo;
import edu.aku.hassannaqvi.hf_patient.core.MainApp;
import edu.aku.hassannaqvi.hf_patient.database.DatabaseHelper;
import edu.aku.hassannaqvi.hf_patient.databinding.ActivityLoginBinding;
...
*//*
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.hf_patient.ui.SyncActivity.class).putExtra("login", true));
        } else {
